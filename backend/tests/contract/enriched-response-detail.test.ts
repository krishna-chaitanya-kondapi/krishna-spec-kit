...
describe('Enriched response detail contract', () => {
  let app: Express
  ...
  it('returns enriched response details for admin', async () => {
    ...
    expect(response.body).toMatchObject({
      ...
      enrichedText: expect.any(String),
      enrichmentContext: expect.any(String),
