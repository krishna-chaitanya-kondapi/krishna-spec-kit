...
describe('Enriched response review contract', () => {
  let app: Express
  ...
  it('creates a review decision for an enriched response', async () => {
    ...
    expect(response.body).toMatchObject({
      enrichedResponseId: submissionId,
      status: 'Approved',
      note: 'Looks good.',
      id: expect.any(String),
      decidedAt: expect.any(String),
      decidedByAdminId: expect.any(String),
    })
  })
})
